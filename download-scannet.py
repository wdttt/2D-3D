...
def main():
    ...
    parser.add_argument('--task_data', action='store_false', help='download task data (v1)')
    parser.add_argument('--label_map', action='store_false', help='download label map file')
